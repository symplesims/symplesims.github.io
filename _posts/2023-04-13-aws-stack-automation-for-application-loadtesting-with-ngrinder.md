...
여기선 AWS Fargate 와 nGrinder 오픈소스를 융합하여 짧은 시간에 테스트 환경을 위한 스택을 구성함은 물론, 개발자에 익숙한 스크립트로 테스트 시나리오를 작성하고, 
작은 규모 에서부터 대규모 엔터프라이즈 환경까지 대응 하는 부하를 원하는 시간에 원하는 만큼 발생 할 수 있었으며, 부하에 반응하는 탄력적인 확장 능력을 갖춘 애플리케이션 또한 확인 할 수 있었습니다.
